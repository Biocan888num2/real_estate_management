...
<body>
    ...
    <div class="container" id="container">
        <div class="form-container sign-up">
            <form enctype="multipart/form-data" action="../controllers/SignupController.php" method="POST">
                <a class="Logos" id= 'logo_create'href="https://maintenanceproof.com/"><img src="../images/logo1.png" alt="Logo of Maintenance Proof"></a>
    ...
    <div class="agreement">
        ...
        <div class="form-container sign-in">
            <form enctype="multipart/form-data" action="../controllers/SignupController.php" method="POST">
                <a class="Logos" id= 'logo_sign'href="https://maintenanceproof.com/"><img src="../images/logo1.png" alt="Logo of Maintenance Proof"></a>
                <h1>Sign In</h1>
                <div class="social-icons">
                    <a href="#" class="icon"><i class="fa-brands fa-google-plus-g" style="color: #dbdbdb;"></i></a>
                    <a href="#" class="icon"><i class="fa-brands fa-facebook-f"style="color: #dbdbdb;"></i></a>
    ...
    <script src="../js/login_script1.js"></script>
